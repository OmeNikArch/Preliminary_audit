...
MONTHS = 1              # тестовый период — 4 недели (правка Никиты в письме 08.09)
...
<section>
  ...
  <div class="stats">
    <div class="stat"><div class="n">{f"{t['imps']/1e6:.1f}".replace('.', ',')} млн</div><div class="t">показов в месяц; 60% бюджета — на Ozon Travel и покупателей товаров в дорогу</div></div>
...
<section>
  ...
  <table class="bench compact">
    <tr><th>Сценарий</th><th>Медиа / мес</th><th>Сопровождение</th><th>Итого / мес</th><th>За тест (4 нед.)</th><th>Показы</th><th>Клики</th><th>CPC</th><th>CPC с сопровождением</th></tr>{trs}
  </table>
  </div>
...
<section>
  <div class="num">{nxt()}</div>
  <div class="kicker"><div class="bar"></div><span>Календарь теста · IV квартал</span></div>
  <h2>Четыре недели<br>с октября</h2>
  <div class="rows">
    ...
    <div class="row"><div class="l">Недели 1–2 · запуск</div><div class="r">Основной флайт — Ozon Travel и покупатели товаров в дорогу (60% бюджета), рядом — пляжный сегмент и широкая аудитория городов вылета, плюс сегмент с высокой активностью от площадки; первые бенчмарки CPM/CTR/CPC по факту.</div></div>
    <div class="row"><div class="l">Недели 3–4 · связка и решение</div><div class="r">Отключаем слабые сегменты, переводим бюджет в сильные; под бюджет согласовываем с Ozon кастомный сегмент путешественников. В конце месяца — документ-решение: что продолжаем, что останавливаем, по вашим критериям. Тогда же — решение по Urban Ads.</div></div>
...
<section>
  ...
  <div class="rows">
    <div class="row"><div class="l">Бюджет</div><div class="r">Оговорённый тест — {money(MAIN)} медиа в месяц плюс сопровождение {money(t['srk2'])} (10%, не меньше 50 000 ₽): {money(t['total2'])} за 4 недели теста, {fmt(t['clicks'])} кликов. Если меньше: {money(SCENARIOS[0][1])} медиа — {money(t_less['total2'])} в месяц, {fmt(t_less['clicks'])} кликов.</div></div>
    <div class="row"><div class="l">Срок</div><div class="r">Тест — 4 недели, по итогам документ-решение. Дальше — помесячно, решения по бюджету по кварталу; контракт от шести месяцев.</div></div>
