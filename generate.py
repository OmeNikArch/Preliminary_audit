...
<section>
  ...
  <div class="cards" style="margin-top:10px">
    <div class="card">
      <h3>Рессейлинг — кабинет ведёте сами: кэшбек с расхода</h3>
      <table class="bench">
        <tr><th>Расход в месяц, без НДС</th><th>Кэшбек клиенту</th></tr>
  ...
  <div class="foot">Кэшбек начисляется раз в квартал — в течение 30 дней по окончании квартала — при суммарном
  ...
  соблюдении минимального расхода в текущем. При работе с СРК кэшбек не выплачивается — действует только
  скидка на сопровождение; вариант «СРК + кэшбек» невозможен. Стоимость СРК указана с НДС.</div>
  <div class="mark">Ц</div>
</section>""")
